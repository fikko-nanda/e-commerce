      ...
      <div className="bg-red-500 text-white border-b-4 border-black p-3 text-xs font-black uppercase">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <span className="bg-yellow-300 text-black px-2 py-0.5 border border-black font-mono">
              ⚡ DEV / TESTING BAR
            </span>
            <span>Pintas Navigasi Mode (Bypass Login)</span>
          </div>

          <div className="flex flex-wrap gap-2">
            <Link
              to="/admin"
              className="bg-black text-white px-3 py-1.5 border-2 border-white hover:bg-yellow-300 hover:text-black transition shadow-brutal"
            >
              👑 Dashboard Admin
            </Link>
            ...
            <Link
              to="/seller"
              className="bg-yellow-300 text-black px-3 py-1.5 border-2 border-black hover:bg-white transition shadow-brutal"
            >
              📊 Dashboard Seller
            </Link>
            ...
            <Link
              to="/seller/register"
              className="bg-white text-black px-3 py-1.5 border-2 border-black hover:bg-yellow-300 transition shadow-brutal"
            >
