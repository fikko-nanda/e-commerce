...
const DUMMY_PRODUCTS = [
  {
    ...
    category: 'tshirt',
    description:
      'Bahan 100% Cotton Combed 24s tebal, potongan oversized brutalist aesthetic dengan sablon plastisol awet.',
    image:
  ...
  },
  {
    ...
    category: 'hoodie',
    description:
      'Fleece tebal 330gsm dengan sablon grafis cyberpunk. Hangat, nyaman, dan berkarakter.',
    image:
  ...
  },
  {
    ...
    category: 'pants',
    description:
      'Celana kargo streetwear banyak saku, jahitan rantai ganda, sangat durable untuk daily wear.',
    image:
  ...
  },
  {
    ...
    description:
      'Tas selempang bahan Cordura waterproof, slot serbaguna untuk kebutuhan daily hangout.',
    image:
        ...
        <div className="bg-yellow-300 border-4 border-black p-8 md:p-12 shadow-brutal-lg mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-sm font-bold leading-relaxed text-black/80">
              Dapatkan produk autentik langsung dari kreator independen
              terbaik.
            </p>
          </div>
        ...
        <div className="bg-black text-white border-4 border-black p-6 md:p-8 shadow-brutal mb-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="space-y-2 max-w-2xl">
            ...
            <p className="text-xs text-gray-300 font-medium leading-relaxed">
              Bergabunglah menjadi seller terverifikasi di WARMART.
              Siapkan KTP, NPWP, dan data legalitas toko Anda untuk proses
              kurasi platform.
            </p>
          </div>
